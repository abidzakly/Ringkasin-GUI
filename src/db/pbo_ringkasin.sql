...
(17, 'Calculus', 'John Doe', 405, '2013', '9823482618', 'Non-Fiksi', NULL, '2023-12-28 00:14:47', '2023-12-28 00:14:47'),
(18, 'Spiderman: Origin', 'John Doe', 352, '2009', '9879248732', 'Fiksi', NULL, '2023-12-28 00:18:02', '2023-12-28 00:18:02');
...
(6, 'Amru Abid', 'abid', 'abid@gmail.com', 'abid1234', 0, 1, '2023-12-25 12:12:13', '2023-12-28 09:38:07'),
(7, 'Nailan Nabil', 'nailann', 'nailan@gmail.com', 'nailan123', 1, 1, '2023-12-25 21:17:26', '2023-12-28 07:56:55'),
(8, 'Ica Aisyah', 'icaaisyah', 'ica@gmail.com', 'hani1234', 0, 1, '2023-12-25 21:17:56', '2023-12-25 22:07:22'),
(9, 'Fawwaz Maulana', 'fwzmaul', 'fwzmaul@gmail.com', 'fwz12345', 1, 1, '2023-12-25 22:02:42', '2023-12-28 05:53:50'),
(10, 'Zefanya Hashiolan', 'olanmanurung', 'olan@gmail.com', 'olan12345', 1, 1, '2023-12-25 22:07:02', '2023-12-28 01:04:05'),
(11, 'Muhtadi Yazid', 'muhtadi21', 'muhtadi@gmail.com', 'muhtadi123', 1, 2, '2023-12-26 05:11:43', '2023-12-26 15:56:42'),
(12, 'Admin', 'admin', 'admin@gmai.com', 'admin123', 1, 2, '2023-12-27 04:06:38', '2024-03-28 03:10:39'),
(13, 'Arrafi Nur', 'rafi21', 'rafi@gmail.com', 'rafi1234', 0, 1, '2024-01-20 12:21:11', '2024-01-20 12:21:48');
...
INSERT INTO `visited` (`id`, `ringkasan_id`, `user_id`, `updated_at`, `created_at`) VALUES
(1, 8, 6, '2023-12-28 05:34:48', '2023-12-28 05:34:39'),
(2, 11, 6, '2023-12-28 07:28:32', '2023-12-28 05:34:45'),
(3, 3, 6, '2023-12-28 08:57:40', '2023-12-28 07:28:08'),
(6, 2, 6, '2023-12-28 08:56:45', '2023-12-28 08:56:45'),
(7, 12, 6, '2023-12-28 08:57:14', '2023-12-28 08:57:14'),
(8, 1, 13, '2024-01-20 12:21:25', '2024-01-20 12:21:25');
...
ALTER TABLE `visited`
  ...
  ADD KEY `fk_books_visited` (`ringkasan_id`);
...
--
ALTER TABLE `statusbuku`
  ADD CONSTRAINT `fk_books_requests` FOREIGN KEY (`book_id`) REFERENCES `buku` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_users_requests` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `visited`
--
ALTER TABLE `visited`
  ADD CONSTRAINT `fk_ringkasan_visited` FOREIGN KEY (`ringkasan_id`) REFERENCES `ringkasan` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
